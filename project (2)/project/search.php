...
<div id="main">
  ...
  <div id="cover">
    ...
    <div id="cover1">
      <div style="margin-left: 20px;text-align: center;"><a href="gio-hang.php"><b style="background-color: orange;z-index: 1;position: absolute;border-radius: 20px;width: 16px;height: 16px;top: 10px;right: 210px;font-size: 13px;color: white">
        <?php if(isset($_SESSION['so'])){
          echo $_SESSION['so'];
        }else{
          echo 0;
    ...
    <div id="cover2">
      ...
      <a href="ve-xe-khach.php" style="color: white">Vé xe khách</a>
