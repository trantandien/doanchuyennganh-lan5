...
<div id="main">
  ...
  </div><div style="margin-left: 150px;margin-top: 30px">
  <a style="color: #0080FF;text-decoration: none;cursor: pointer;" href="../quanly.php">Quay Lại</a>
  </div><center>
  <div id="noidung">
  <?php
$id=$_GET['id'];
$stmt=$conn->prepare("SELECT * FROM thanhvien WHERE id=$id");
$stmt->execute();
$data = $stmt->fetch(PDO::FETCH_ASSOC);
  ?>
<img align="left" style="margin-left: 150px;margin-top: 20px" width="120px" src="../image/avatar.png">
<div style="float: left;margin-left: 50px;text-align: left;margin-top: 20px;margin-bottom: 50px"><br>
<?php echo $data['TenTV']; ?><br>
<?php echo "0".$data['Phone']; ?></br>
<?php echo $data['Email']; ?><br>
<?php echo $data['Diachi']; ?><br>
</div>
  </div>
