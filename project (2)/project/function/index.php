<div style="width: all;clear: both;padding:0 150px;height: 250px"><br>
  ...
  <?php
    ...
    $stmt->execute();
    $chuyenxe = $stmt->fetchAll(PDO::FETCH_ASSOC);
  ?>
  <?php foreach ($chuyenxe as $chuyen) {?>
  <div class="chuyen" style="line-height: 30px;float: left;width: all;margin-left: 450px;margin-right: 360px">
    <div style="text-align: left;float: left;width: 120px"><?php echo $chuyen['Diemdi']; ?></div>
    <div style="text-align: left;float: left;margin-left: 50px;width: 50px"><img width="20" align="center" src="image/go.png"></div>
    <div style="text-align: left;float: left;margin-left: 30px;width: 120px"><?php echo $chuyen['Diemden']; ?></div>
      <div style="float: right;"><a href="chon-xe1.php?id=<?php echo $chuyen['id'] ?>"><button style="color: white;width: 80px;height: 30px;font-weight: bold;">Chọn</button></a></div>
      </div>
      <br>
      <br>
  <?php } ?>
