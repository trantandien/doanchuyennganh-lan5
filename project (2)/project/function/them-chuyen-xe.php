...
<div id="main">
  ...
  <table>
    <tr>
      <td><h3 style="float: left;"><img align="center" width="30" src="image/phone.png"> (08h - 22h) 01657002257</h3></td><td><h3 style="float: left;border: 1px solid #DF7401;border-top: none;border-bottom: none;padding:0 25px;"><img align="center" width="30" src="image/phone.png"> (08h - 17h) 0909998888</h3></td><td><h3 style="float: left;"><img align="center" width="30" src="image/phone.png"> (08h - 22h) 0828888888</h3>
      </td>
    </tr>
  </table>
  </div>
...
if(isset($_GET['btnThem'])){
  $giodi=$_GET['txtGiodi']."h".$_GET['txtPhutdi'];
  $gioden=$_GET['txtGioden']."h".$_GET['txtPhutden'];
  $data=array(
      'Giodi' => $giodi,
      'Gioden' => $gioden,
      'Diemdi' => $_GET['noi-di'],
   ...
   $stmt = $conn->prepare("INSERT INTO chuyenxe(Giodi,Gioden,Diemdi,Diemden,Giave) VALUES (:Giodi,:Gioden,:Diemdi,:Diemden,:Giave)");
            $stmt->bindParam(":Giodi",$giodi,PDO::PARAM_STR);
            $stmt->bindParam(":Gioden",$gioden,PDO::PARAM_STR);
            $stmt->bindParam(":Diemdi",$_GET['noi-di'],PDO::PARAM_STR);
            $stmt->bindParam(":Diemden",$_GET['noi-den'],PDO::PARAM_STR);
            $stmt->bindParam(":Giave",$_GET['txtGiave'],PDO::PARAM_INT);
            $stmt->execute();
...
<tr>
  <td>Giờ Đi</td>
  <td><input style="margin-left: -60px" type="number" name="txtGiodi" min="0" max="23" value="00"> : <input type="number" name="txtPhutdi" min="0" max="59" value="00"></td>
</tr>
<tr>
  <td>Giờ Đến</td>
  <td><input style="margin-left: -60px" type="number" name="txtGioden" min="0" max="23" value="00"> : <input type="number" name="txtPhutden" min="0" max="59" value="00"></td>
</tr>
<tr>
  <td>Điểm Đi</td>
  <td><select style="width: 124px" name="noi-di">
        </select></td>
</tr>
<tr>
  <td>Điểm Đến</td>
  <td><select style="width: 124px" name="noi-den">
        </select></td>
</tr>
<tr>
  <td>Giá Vé</td>
  <td><input style="margin-left: -60px;width: 120px" type="text" name="txtGiave"></td>
</tr>
<tr>
  <td colspan="2"><button style="margin-left: 110px;color: white;padding: 5px 20px" type="submit" name="btnThem">Thêm Chuyến Xe</button></td>
</tr>
</table>
</form>
</div>
