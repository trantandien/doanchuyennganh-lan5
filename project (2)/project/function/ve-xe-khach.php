...
<div class="chuyen" style="line-height: 30px;float: left;width: all;margin-left: 100px;margin-left: 300px; margin-bottom: 10px;" >
    <div style="text-align: left;float: left;width: 150px">
      <?php echo $chuyen['Diemdi']; ?>     
    </div>
    <div style="text-align: left;float: left;margin-left: 50px;width: 50px"><img width="20" align="center" src="image/go.png"></div>
    <div style="text-align: left;float: left;margin-left: 30px;width: 200px">
      <?php echo $chuyen['Diemden']; ?>
    </div>
     <div style="text-align: left;float: left;margin-left: 30px;width: 200px">
        <b style="color: #FE9A2E">
        <?php echo number_format($chuyen['Giave'],0,',','.')." VNĐ"; ?> 
        </b>
    </div>
    <div style="text-align: center;float: left;margin-top: 0px;width: 10px">
      <a href="chon-xe.php?id=<?php echo $chuyen['id'] ?>">
