...
<?php
$idget=$_GET['id'];
$stmt=$conn->prepare("SELECT * FROM chuyenxe JOIN xe ON xe.id=chuyenxe.id_xe WHERE chuyenxe.id_lotrinh=$idget");
$stmt->execute();
$data = $stmt->fetchAll(PDO::FETCH_ASSOC);
?>
<table style="border: 5px;background: #045FB4;color: white;line-height: 50px;font-size: 10px;font-weight: bolder;">
  <tr>
...
<?php foreach ($data as $chonxe) {?>
  ...
  ?>
    ...
    <td align="center" width="30px" rowspan="3"><?php echo $tgd=(floor($datediff / (60*60))+ floor($timediff / (60*60))."H"); ?></td>
    <td align="center" width="110px"><?php echo $chonxe['Gioden']; ?></td>
    <td align="center" width="100px" colspan="4"><?php echo $chonxe['Soluongghe']." chỗ<br>Còn trống ".$chonxe['Chotrong']; ?></td>
    <td align="center" width="20px" rowspan="3"><?php echo number_format($chonxe['Giave'],0,',','.')." VNĐ"; ?></td>
  ...
  <tr>
    <td align="center" width="100px" rowspan="2"><img width="15" src="image/star.png"><img width="15" src="image/star.png"><img width="15" src="image/star.png"><img width="15" src="image/star.png"><img width="15" src="image/star.png"></td>
    <td align="center" width="200px"><?php echo $chonxe['Diemdi']; ?></td>
    <td align="center" width="150px"><?php echo $chonxe['Diemden']; ?></td>
    <td align="center" width="200px" rowspan="2"> <img width="20" src="image/nuoc.png"><img width="20" src="image/banh.png"> <img width="20" src="image/wifi.png"></td>
  </tr>

  <tr>
    <td align="center" width="20px"><?php echo $chonxe['Ngaydi']; ?></td>
    <td align="center" width="200px"><?php echo $chonxe['Ngayve']; ?></td>
  </tr>
