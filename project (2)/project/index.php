...
<img src="image/gs1.jpg" width="100%" height="430">
</div>
<div class="mySlides fade">
<img src="image/gs.jpg" width="100%" height="430">
</div>
<div class="mySlides fade">
...
<div>
  ...
  <div id="form" style="position: absolute;top:20px;background-color: white;width: 360px;left: 140px;height: 320px;opacity: 0.6">.
  </div>
    <table style="border: none;position: absolute;top:20px;font-weight: bold;">
      <tr>
        <td style="font-size: 15px">
          <input id="trip0" type="radio" name="trip" value="0" checked=""> Vé một chiều
        </td>
        <td colspan="" style="font-size: 15px">
          <input id="trip1" type="radio" name="trip" value="1"> Vé khứ hồi
        </td>
      </tr>
      <tr>
      ...
      <tr id="ngayve"></tr>
      <tr>
        <td colspan="2"><button type="submit" style="border: none;background-color: #FF8000;width: 150px;height: 40px;margin-right: 15px;float: right;border-radius: 0 10px 10px 0"><b>TÌM XE</b></button><button id="bnt" type="submit" style="border: none;background-color: #F5D0A9;width: 50px;height: 40px;float: right;border-radius: 10px 0 0 10px;"><img align="center" width="20" src="image/search.png"></button></td>
      </tr>
    </table>
  </form>
  <table>
  ...
  <table align="center" style="border: none; border-bottom: 1px solid #FF8000;padding-bottom: 50px">
    <tr>
      ...
      <td rowspan="5">   
  <embed allowscriptaccess="always" flashvars="bannerWidth=250&bannerHeight=250&bannerSID=http://img.uu1001.cn/x3/2011-11-15/18-00/2011-11-15_c908881393a00a66083c07864753e7c8_0.xml&bannerXML=&bannerLink=http%3A%2F%2F&dataSource=&bid=26523091&appSource=default" id="26523091" name="26523091" quality="high" src="http://img.uu1001.cn/bcv3.swf?v=20111012" type="application/x-shockwave-flash" wmode="transparent" height="250">
      </td>
    </tr>
    <tr>
